...
def analyze_video_from_ram(video_bytes: bytes, timeout_seconds: int = 300):
    ...
    try:
        ...
        analysis = client.analyze(
            ...
            prompt="Give a detailed summary of the video content and and explain in a step by step process what is happening. Also, do NOT make any assumptions about anything not clearly shown in the video, no assumptions should be made about anything.",
...
def main():
    # Example usage
    with open("RecordingTest2.mov", "rb") as f:
        video_data = f.read()
